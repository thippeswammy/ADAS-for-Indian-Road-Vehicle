if __name__ == '__main__':
    ...
    # Training parameters
    train_params = {
        'data': r'F:\RunningProjects\ADAS-for-Indian-Road-Vehicle\DatasetCreator\YoloDatasetProcessor\dataset_saving_working_dir\road\data.yaml',
        # Ensure data.yaml has correct paths and classes
        'epochs': 10,  # Increased from 1 for meaningful training; adjust based on dataset size
        ...
        'workers': 1,  # Increased for faster data loading, adjust based on CPU cores
        ...
        'name': 'RoadSegmentation_11_04_2025',  # Descriptive name
