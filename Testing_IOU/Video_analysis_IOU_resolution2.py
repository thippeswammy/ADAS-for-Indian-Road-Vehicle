...
output_file = r"F:\RunningProjects\YOLO_Model\val\Results\evaluation_results.txt"

# Image resolutions to evaluate
# image_sizes = [(640, 384), (640, 640), (1920, 1080), (1280, 720), (480, 640), (1024, 768), (800, 600), (320, 240)]
image_sizes = [
    (i, j)
    for i in range(128, 2001, 128)  # Width between 128 and 2000, stepping by 32
    for j in range(128, 2001, 128)  # Height between 128 and 2000, stepping by 32
]
