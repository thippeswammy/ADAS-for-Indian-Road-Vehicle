...
output_file = r"/val/Results/evaluation_results6_2F.txt"
excel_file = r"/val/Results/evaluation_results6_2F.xlsx"
...
# image_sizes = [
#     (i, j) for i in range(128, 1200, 128)
#     for j in range(i, 1200, 128)
# ]
...
for width, height in image_sizes:
    output_dir = output_dir + f"{width}x{height}"
